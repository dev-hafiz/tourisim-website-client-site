              ...
              <div className="container placeBooking-tour">
                  ...
                  <h2 className="place-heading">Place Your Booking </h2>
                   ...
                   <form onSubmit={handleSubmit(onSubmit)}>
                         <input defaultValue={place.title} {...register("title")} placeholder="title" />
                         <textarea  defaultValue={place.des} {...register("des")} placeholder="description" />
                         <input  defaultValue={place.img} {...register("img")} placeholder="imgUrl" />
