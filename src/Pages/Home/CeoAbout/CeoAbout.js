     ...
     return (
          ...
          <div className="row d-flex align-items-center">
               ...
               <div className="col-lg-4 col-md-6 col-12">
                 ...
                 <span><NavLink className="text-decoration-none " to="/home"><i className="fab social fa-linkedin-in"></i></NavLink></span>
                 <span><NavLink className="text-decoration-none "  to="/home"><i className="fab social fa-twitter"></i></NavLink></span>
                 <span><NavLink className="text-decoration-none "  to="/home"><i className="fab social fa-facebook-f"></i></NavLink></span>
                 <span><NavLink className="text-decoration-none "  to="/home"><i className="fab social fa-reddit-alien"></i></NavLink></span>
               </div>
          </div>
